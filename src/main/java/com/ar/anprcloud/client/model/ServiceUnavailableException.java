...
public class ServiceUnavailableException extends com.ar.anprcloud.client.model.ANPRCloudServiceException {
    ...
    public ServiceUnavailableException version(String version) {
        setVersion(version);
        return this;
    }
