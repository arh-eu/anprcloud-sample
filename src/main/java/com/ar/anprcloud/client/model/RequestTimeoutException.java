...
public class RequestTimeoutException extends com.ar.anprcloud.client.model.ANPRCloudServiceException {
    ...
    public RequestTimeoutException error(String... error) {
        if (this.error == null) {
    ...
    public RequestTimeoutException error(java.util.Collection<String> error) {
        setError(error);
        return this;
    }
    ...
    public RequestTimeoutException node(String node) {
        setNode(node);
        return this;
    }
    ...
    public RequestTimeoutException nodetime(Integer nodetime) {
    ...
    public RequestTimeoutException version(String version) {
        setVersion(version);
        return this;
    }
