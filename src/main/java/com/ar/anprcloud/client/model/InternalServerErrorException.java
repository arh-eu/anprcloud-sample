...
public class InternalServerErrorException extends com.ar.anprcloud.client.model.ANPRCloudServiceException {
    ...
    public InternalServerErrorException error(String... error) {
        if (this.error == null) {
    ...
    public InternalServerErrorException error(java.util.Collection<String> error) {
        setError(error);
        return this;
    }
    ...
    public InternalServerErrorException node(String node) {
        setNode(node);
        return this;
    }
    ...
    public InternalServerErrorException nodetime(Integer nodetime) {
    ...
    public InternalServerErrorException version(String version) {
        setVersion(version);
        return this;
    }
