...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ol6anslmcc-2020-05-04T08:02:27Z/CharROI" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CharROI implements Serializable, Cloneable, StructuredPojo {
    ...
    public CharROI bottomLeft(BottomLeft bottomLeft) {
    ...
    public CharROI bottomRight(BottomRight bottomRight) {
    ...
    public CharROI topLeft(TopLeft topLeft) {
        setTopLeft(topLeft);
        return this;
    }
    ...
    public CharROI topRight(TopRight topRight) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CharROI == false)
            return false;
        CharROI other = (CharROI) obj;
    ...
    @Override
    public CharROI clone() {
        try {
            return (CharROI) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        hu.arh.anprcloud.client.model.transform.CharROIMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
