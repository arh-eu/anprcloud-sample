...
import hu.arh.anprcloud.client.model.transform.ANPRCloudRequestProtocolMarshaller;
import hu.arh.anprcloud.client.model.transform.ANPRCloudResultJsonUnmarshaller;
import hu.arh.anprcloud.client.apigateway.ApiGatewayProtocolFactoryImpl;
import hu.arh.anprcloud.client.model.BadRequestException;
import hu.arh.anprcloud.client.model.InternalServerErrorException;
import hu.arh.anprcloud.client.model.NotFoundException;
            ...
            new JsonClientMetadata().withProtocolVersion("1.1").withSupportsCbor(true).withSupportsIon(true)/*.withContentTypeOverride("multipart/form-data")*/
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("NotFoundException").withModeledClass(
                                    hu.arh.anprcloud.client.model.NotFoundException.class))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("ServiceUnavailableException").withModeledClass(
                                    hu.arh.anprcloud.client.model.ServiceUnavailableException.class))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("RequestTimeoutException").withModeledClass(
                                    hu.arh.anprcloud.client.model.RequestTimeoutException.class))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("BadRequestException").withModeledClass(
                                    hu.arh.anprcloud.client.model.BadRequestException.class))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("InternalServerErrorException").withModeledClass(
                                    hu.arh.anprcloud.client.model.InternalServerErrorException.class))
                    .withBaseServiceExceptionClass(hu.arh.anprcloud.client.model.ANPRCloudServiceException.class));
